...
function realPath(file) {
    ...
    try {
        ...
        // A missing leaf can still have a symlink/junction in an existing parent.
...
module.exports = { fs, path, writeChanged, stripComments, stamp, hashFile, relativeTo, realPath, insidePath, isInside };
